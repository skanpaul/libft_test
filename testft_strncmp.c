...
printf("****************************************************\n");
	...
	n = -1; 	skan_error(text1, text2, n);	
	n = 0; 		skan_error(text1, text2, n);	
	n = 1; 		skan_error(text1, text2, n);
	n = 2; 		skan_error(text1, text2, n);
	n = 6; 		skan_error(text1, text2, n);
	n = 7; 		skan_error(text1, text2, n);
	n = 8; 		skan_error(text1, text2, n);
	n = 15; 	skan_error(text1, text2, n);
